...
// NewProvideGRPCServer new a gRPC server.
func NewProvideGRPCServer(c *conf.Server, svc *service.ProvideService, logger log.Logger) *grpc.Server {
	...
	provide.RegisterProvideServer(srv, svc)
	return srv
}
